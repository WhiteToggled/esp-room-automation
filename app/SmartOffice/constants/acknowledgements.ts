...
export const PROJECT_DETAIL = 'COAL Project · Semester 4 · UET';

export const CONTRIBUTORS: Contributor[] = [
  { name: 'Abdullah Amir (2024-CS-156)', role: 'Frontend Developer' },
  { name: 'Ahmed Effiendi (2024-CS-170)', role: 'Hardware & ESP32 Firmware' },
...
export const SUPERVISOR = 'Sir Tehseen Ul Haq and Sir Ashir';
